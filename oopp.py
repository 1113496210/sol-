...
# 成交额门槛
MIN_24H_VOLUME_USDT = 15_000_000  # 1300万 USDT
...
# ===================== 主循环 =====================
def main_loop():
    logger.info(f"🚀 融合监控系统启动（三通道版 · {MIN_24H_VOLUME_USDT//10000}万门槛 + 历史信号关联）")
    notify_all(
        f"✅ 融合监控系统启动（三通道版 + 历史信号关联）\n"
        f"🚀 通道1：确认信号（多因子验证）\n"
